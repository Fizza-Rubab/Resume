...
\leftheader{%
  {\LARGE\bfseries\sffamily Fizza Rubab, B.Sc.}

  \makefield{\faEnvelope[regular]}{\href{mailto:example@gmail.com}{\texttt{fizzaa39@gmail.com}}}
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/fizza-rubab-256bb41b4}{\texttt{fizza-rubab}}}
...
\rightheader{~}
% \begin{fullonly}
% \photo[r]{fizzarubab_photo1622999723}
% \photoscale{0.12}
% \end{fullonly}
